...
class App_config_seeder extends Seeder
{
    ...
    public function run()
    {
      DB::table('app_config')->where('id',1)->update(
        ...
        'settlements_arrangements' => 'cash,credit,debit,cheque,guest_ledger,send_bill,bad_order,staff_charge,free_of_charge,manager_meals,sales_office,representation,cancelled'
        ]
      );
    }
}
