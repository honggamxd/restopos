    ...
    public function store(Request $request)
    {
        $this->validate(
            ...
            [
                ...
                // 'approved_by_2_name' => 'required',
                'approved_by_2_date' => 'date',
                // 'approved_by_2_position' => 'required',
                // 'verified_as_funded_by_name' => 'required',
                'verified_as_funded_by_date' => 'date',
                // 'verified_as_funded_by_position' => 'required',
                // 'recorded_by_name' => 'required',
                'recorded_by_date' => 'date',
                // 'recorded_by_position' => 'required',
            ],
            [
                'capital_expenditure_request_number.required' => 'The budget number field is required.',
                'capital_expenditure_request_number.numeric' => 'The budget number is already in the list.',
                'capital_expenditure_request_date.required' => 'The date field is required.',
                'requested_by_name.required' => 'The name field is required.',
                'requested_by_position.required' => 'The position field is required.',
                'requested_by_date.date' => 'The date field is not a valid date',
                'approved_by_1_date.date' => 'The date field is not a valid date',
                'approved_by_2_date.date' => 'The date field is not a valid date',
                'verified_as_funded_by_date.date' => 'The date field is not a valid date',
                'recorded_by_date.date' => 'The date field is not a valid date',
            ]
        );
        DB::beginTransaction();
        try{
            ...
            $capital_expenditure_request->budget_amount = $request->budget_amount;
