...
<a class="section hideprint" href="{{route('inventory.purchase-request.create')}}" ng-if="user_data.privilege == 'admin' || user_data.permissions.can_add_purchase_requests">Create Purchase Request</a>
<i class="divider" ng-if="user_data.privilege == 'admin' || user_data.permissions.can_add_purchase_requests">|</i>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">
                                <div class="ui buttons">
                                    <button type="button" class="ui green button" ng-click="approve_confirm(item,index)" ng-if="!item.is_approved && (user_data.privilege == 'admin' || user_data.permissions.can_approve_purchase_requests)"><span class="glyphicon glyphicon-ok"></span></button>
                                    <button type="button" class="ui blue button" ng-click="edit_form(item)" ng-if="user_data.privilege == 'admin' || user_data.permissions.can_edit_purchase_requests"><span class="glyphicon glyphicon-edit"></span></button>
                                    <button type="button" class="ui red button" ng-click="delete_confirm(item)" ng-if="user_data.privilege == 'admin' || user_data.permissions.can_delete_purchase_requests"><span class="glyphicon glyphicon-trash"></span></button>
                                </div>
                            </td>
                        </tr>
                    </tbody>
